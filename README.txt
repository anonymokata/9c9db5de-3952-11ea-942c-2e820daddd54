...
The environment required to build this solution and run these tests includes a Linux environment with any g++ version with C++11 support and the ability to run makefiles.
